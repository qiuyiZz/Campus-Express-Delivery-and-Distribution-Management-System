...
                oName.setAttribute("placeholder",name);
                ...
                oJob.setAttribute("placeholder",job);
             };
     </script>
</head>
<body>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6">
                                                <div class="form-group name">
                                                    <label>姓名</label>
                                                    <input type="text" name="name" id="name" class="form-control" placeholder="李会地">
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6">
                                                <div class="form-group email">
                                                    <label>角色</label>
                                                    <input type="text" name="role" id="role" class="form-control" placeholder="员工">
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6">
                                                <div class="form-group subject">
                                                    <label>工号</label>
                                                    <input type="text" name="phone" id="phone" class="form-control" placeholder="018">
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6">
                                                <div class="form-group number">
                                                    <label>岗位</label>
                                                    <input type="text" name="job" id="job" class="form-control" placeholder="派件员">
                                                </div>
                                            </div>
