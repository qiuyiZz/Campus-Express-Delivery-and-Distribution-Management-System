...
 </script>
    ...
    Double rate = (double) ((Math.round(totaloccupy/totalgrid * 100)) / 100.0);//快递柜占用率 保留两位小数
	%>
</head>
   ...
   <div class="header">
        ...
        <div class="demo">
            ...
            <div class="booking-details">
                ...
                <form action="save_grid" method="get">
                    ...
                    <input type="hidden" value="2区5号" name="grid" />
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            /*已售出的座位*/
            //sc.get(['1_1','1_5','2_4']).status('unavailable');
            var reg = new RegExp('"',"g");  
			var newStr = occupyList.replace(reg, "");
            sc.get(newStr).status('unavailable');
        });
        /*计算总金额*/
