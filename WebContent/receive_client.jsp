...
<head>
   ...
   int num=Integer.parseInt(session.getAttribute("num_rc").toString());
   String jsonStringrr=session.getAttribute("array_rc").toString();
        ...
        <div class="width1003">
          <div class="PublicContentBox">
                ...
                <div class="PublicPointToAgeText">
                    <span class="span1">我收的</span> <span class="span2">收件列表</span>
                </div>
                <!--查询-->
...
' <td>'+data[i].g+'</td>'+
' <td>'+data[i].h+'</td>'+
' <td> <div class="PublicTableBtnIcon Color4Btn Js_detain" onclick="del(&quot;'+ data[i].a+'&quot;)"> <span>取件</span></div></td>'+
'</tr>';}
document.getElementById("result_rc").innerHTML = html;
