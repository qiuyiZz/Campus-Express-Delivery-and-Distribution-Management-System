    ...
    <div class="dashboard">
                ...
                <div class="col-lg-3 col-md-12 col-sm-12 col-pad">
                    <div class="dashboard-nav d-none d-xl-block d-lg-block">
                        <div class="dashboard-inner">
                            <h4>消息</h4>
                            <ul>
                                <li class="active"><a href="message.jsp"><i class="flaticon-mail"></i>消息提醒<span class="nav-tag">6</span></a></li>
                            </ul>
                            <h4>账户</h4>
                            <ul>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="comment">
                                            <div class="comment-author">
                                                <a href="#">
                                                    <img src="/Express/static/img/avatar/avatar-1.jpg" alt="comments-user">
                                                </a>
                                            </div>
                                            <div class="comment-content">
                                                <div class="comment-meta">
                                                    ...
                                                    <div class="comment-meta">
                                                        8:42 PM 1/28/2020<a href="#">详情</a>
                                                    </div>
                                                </div>
                                                <p>您有一个问题件待处理，问题件运单号为：*************</p>
                                            </div>
                                        </div>
                                        <div class="comment">
                                            <div class="comment-author">
                                                <a href="#">
                                                    <img src="/Express/static/img/avatar/avatar-2.jpg" alt="comments-user">
                                                </a>
                                            </div>
                                            <div class="comment-content">
                                                <div class="comment-meta">
                                                ...
                                                <p>您今天已派送30件快递，还有50件未派送，请继续加油！</p>
                                            </div>
                                        </div>
                                        <div class="comment">
                                            <div class="comment-author">
                                                <a href="#">
                                                    <img src="/Express/static/img/avatar/avatar-3.jpg" alt="comments-user">
                                                </a>
                                            </div>
                                            <div class="comment-content">
                                                <div class="comment-meta">
                                                ...
                                                <p>您来自百世汇通的快递已到达元创易站，订单号：*********，存放地点：***，取件码：****，请及时取件！</p>
                                            </div>
                                        </div>
                                        <div class="comment comment-b">
                                            <div class="comment-author">
                                                <a href="#">
                                                    <img src="/Express/static/img/avatar/avatar-4.jpg" alt="comments-user">
                                                </a>
                                            </div>
                                            <div class="comment-content">
                                                <div class="comment-meta">
                                                ...
                                                <p>您的快件已寄出，订单号：********，寄出时间：*******，预计5天后到达目的地，请提醒收件方及时查收。</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
      ...
      <ul>
       ...
       <div class="clearfix"></div>
        ...
        <!-- IE10 viewport hack for Surface/desktop Windows 8 bug -->
        <script src="/Express/static/js1/ie10-viewport-bug-workaround.js"></script>
        <!-- Custom javascript -->
        <script src="/Express/static/js1/ie10-viewport-bug-workaround.js"></script>
</body>
</html>
